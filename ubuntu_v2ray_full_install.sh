...
# https://v2raytech.com/ubuntu-v2ray-one-click-script-with-mask/
...
installV2ray() {
    ...
    bash <(curl -sL ${V6_PROXY}https://raw.githubusercontent.com/zfdang/scripts/main/v2ray_core_install.sh)
